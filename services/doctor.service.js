...
module.exports.getAllDoctor = async (
  role,
  userId,
  filters = {},
  page = 1,
  ...
  if (filters.specializationId)
    find.specializationId = filters.specializationId;
  ...
  let doctors = await Doctor_user.find(find)
    ...
    .populate({
      path: "clinicId",
      select: "name address phone description image",
    })
...
module.exports.createDoctor = async (body) => {
  ...
  (newDoctor.thumbnail = thumbnail), (newDoctor.clinicId = clinicId);
